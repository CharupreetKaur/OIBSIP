This repository consists of servlet, jsp, html and css files for creating a Number Guessing Game. The game allows users to guess a randomly generated number between 1 and 100. In total we have 6 files:
